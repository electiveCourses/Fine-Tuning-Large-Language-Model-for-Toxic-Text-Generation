...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate Qwen baseline on prompts with toxicity scoring (fast version).")
    ...
    parser.add_argument('--output', type=str, default='data/processed/qwen_baseline_eval_with_toxicity.csv', help='Output CSV file')
